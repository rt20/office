        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    @endif
                    <form class="w-full" action="{{ route('items.update',$item->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input value="{{ old('nup') ?? $item->nup }}" name="nup"
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="tahun_perolehan"
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    style="width: 100%;" value="{{old('tahun_perolehan')?? $item->tahun_perolehan }}">
                            </div>
                            <div class="col-sm-1">
                            ...
                            <div class="col-sm-3">
                                <select name="kondisi" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    ...
                                    <option value="{{ $item->kondisi }}" {{$item->kondisi ? 'selected':null}}>
                                    {{$item->kondisi}} </option>
