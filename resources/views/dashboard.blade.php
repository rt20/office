          ...
          <div class="col-md-8">
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-sm btn-info float-left">Pinjam Lagi</a>
                <a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">Lihat Semua Peminjaman</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
